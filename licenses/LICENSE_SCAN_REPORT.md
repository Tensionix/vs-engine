...
- Project: **Audion VS Engine** (`audion-vs-engine`)
- Run: `20260824T174909Z_audion-vs-engine_28c39aae`
- Project root: `S:\Release\Audion VS Engine`
- Scan root: `S:\Release\Audion VS Engine`
- Output: `S:\Release\Audion VS Engine\licenses`
- Status: **PASS**
- Components: 81
- Bundled: 81
- Optional runtime: 0
...
| build | `NEW_COMPONENT_APPROVED_PROFILE` | - | 1.5.0 |
| certifi | `NEW_COMPONENT_APPROVED_PROFILE` | - | 2026.7.22 |
| cffi | `NEW_COMPONENT_APPROVED_PROFILE` | - | 2.1.1 |
| charset-normalizer | `NEW_COMPONENT_APPROVED_PROFILE` | - | 3.5.1 |
...
| FFmpeg | `NEW_COMPONENT_APPROVED_PROFILE` | - | 8.0.1-full_build-www.gyan.dev |
...
| lxml | `NEW_COMPONENT_APPROVED_PROFILE` | - | 6.1.2 |
...
| pip-tools | `NEW_COMPONENT_APPROVED_PROFILE` | - | 7.6.1 |
...
| psutil | `NEW_COMPONENT_APPROVED_PROFILE` | - | 7.2.2 |
...
| pyproject_hooks | `NEW_COMPONENT_APPROVED_PROFILE` | - | 1.2.0 |
| pytest | `NEW_COMPONENT_APPROVED_PROFILE` | - | 9.1.1 |
| python-docx | `NEW_COMPONENT_APPROVED_PROFILE` | - | 1.2.0 |
...
| requests | `NEW_COMPONENT_APPROVED_PROFILE` | - | 2.34.2 |
...
| urllib3 | `NEW_COMPONENT_APPROVED_PROFILE` | - | 2.7.0 |
