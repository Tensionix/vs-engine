...
MATERIAL_ICONS = {
    ...
    "install_mlrt_lean": "psychology",
    "install_mlrt_full": "psychology_alt",
...
TEXT = {
    "ru": {
        ...
        "install_mlrt_lean": "MLRT LEAN",
        "install_mlrt_full": "MLRT FULL",
        ...
        "install_mlrt_lean_tooltip": "Установить/обновить MLRT, затем trim под локальный GPU",
        "install_mlrt_full_tooltip": "Установить/обновить полный MLRT bundle без trim",
    },
    "en": {
        "cancel": "Cancel",
        "back": "Back",
        ...
        "install_mlrt_lean_tooltip": "Install/update MLRT, then trim to the local GPU",
        "install_mlrt_full_tooltip": "Install/update the full MLRT bundle without trim",
    },
}
...
async def run_installer(command_id: str) -> None:
    commands = {
        ...
        "mlrt_lean": cmd_wrapper_command("Install-VS-mlrt.cmd", "/LEAN", "/NOPAUSE"),
        "mlrt_full": cmd_wrapper_command("Install-VS-mlrt.cmd", "/FULL", "/NOPAUSE"),
    }
    titles = {
        "vs": "install/vapoursynth",
        "vs_plugins": "install/vs-plugins",
        "ffmpeg": "install/ffmpeg",
        "mlrt_lean": "install/vs-mlrt-lean",
        "mlrt_full": "install/vs-mlrt-full",
    }
...
def render_main_dashboard() -> None:
    ...
    with ui.element("div").classes("dashboard-grid"):
        ...
        with ui.element("div").classes("panel dashboard-card environment-card"):
            ...
            with ui.element("div").classes("dashboard-actions environment-actions-grid install-grid-5"):
                ...
                mlrt_lean_button = dashboard_button("install_mlrt_lean", lambda: run_installer("mlrt_lean"), extra_classes="environment-service-button")
                mlrt_lean_button.tooltip(tr("install_mlrt_lean_tooltip"))
                mlrt_full_button = dashboard_button("install_mlrt_full", lambda: run_installer("mlrt_full"), extra_classes="environment-service-button")
                mlrt_full_button.tooltip(tr("install_mlrt_full_tooltip"))
            ui.label("VS host / plugins / FFmpeg / MLRT install").classes("module-summary")
...
def build_ui() -> None:
    ...
    with ui.header().classes("app-header items-center justify-between px-4"):
        ui.label("Audion VS Engine").classes("app-header-title text-base font-bold")
