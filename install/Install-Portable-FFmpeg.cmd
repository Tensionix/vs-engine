...
title Audion VS Engine - Install Portable FFmpeg BtbN Release

set "SCRIPT_DIR=%~dp0"
if "%SCRIPT_DIR:~-1%"=="\" set "SCRIPT_DIR=%SCRIPT_DIR:~0,-1%"
for %%A in ("%SCRIPT_DIR%\..") do set "ROOT=%%~fA"

set "PS1_FILE=%SCRIPT_DIR%\Install-Portable-FFmpeg.ps1"
...
echo ======================================================================
echo   AUDION VS ENGINE - INSTALL PORTABLE FFMPEG BTBN RELEASE
echo ======================================================================
