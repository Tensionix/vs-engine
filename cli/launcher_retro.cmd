...
>>"%MENU_FILE%" echo [03] Polaroid                              ^| polaroid        ^| 1970s SX-70: candy-bloom, warm cream, edge vignette
>>"%MENU_FILE%" echo.
>>"%MENU_FILE%" echo === Tools ==========================================================
>>"%MENU_FILE%" echo [04] List encoders                         ^| list_encoders   ^| H.264 / H.265 / ProRes / DNxHR
>>"%MENU_FILE%" echo [05] Doctor                                ^| doctor          ^| full stack health
>>"%MENU_FILE%" echo [06] Open input folder                     ^| open_input      ^| Explorer
>>"%MENU_FILE%" echo [07] Open output folder                    ^| open_output     ^| Explorer
>>"%MENU_FILE%" echo [08] Open logs folder                      ^| open_logs       ^| JSON reports
...
echo [3] Polaroid              (1970s SX-70 vibe, candy-bloom, vignette)
echo.
echo === Tools ===
...
set "VIGNETTE="
echo.
echo Edge vignette (corner darkness; 0 = none, 1 = corners go to black):
echo   1 - 0.30  (subtle)
echo   2 - 0.55  (default Polaroid)
echo   3 - 0.80  (heavy)
set /p VIGNETTE=Select [2] :
