...
>>"%MENU_FILE%" echo [14] VS-MLRT LEAN                          ^| install_mlrt      ^| install/trim MLRT for local GPU
>>"%MENU_FILE%" echo [15] VS-MLRT FULL                          ^| install_mlrt_full ^| install full MLRT bundle
>>"%MENU_FILE%" echo.
...
if /I "%RAW%"=="install_mlrt" goto INSTALL_MLRT
if /I "%RAW%"=="install_mlrt_full" goto INSTALL_MLRT_FULL
...
echo [14] VS-MLRT LEAN
echo [15] VS-MLRT FULL
echo.
...
if /I "%RAW%"=="install_ffmpeg_gyan" goto INSTALL_FFMPEG_GYAN
if /I "%RAW%"=="14" goto INSTALL_MLRT
if /I "%RAW%"=="install_mlrt" goto INSTALL_MLRT
if /I "%RAW%"=="15" goto INSTALL_MLRT_FULL
if /I "%RAW%"=="install_mlrt_full" goto INSTALL_MLRT_FULL
...
:INSTALL_MLRT
rem Default: lean trim for local GPU SM. Cache cleanup is a separate
rem explicit step via [70] CLEAN INSTALL CACHE.
call "%BASE_DIR%\install\Install-VS-mlrt.cmd" /LEAN
goto MAIN

:INSTALL_MLRT_FULL
call "%BASE_DIR%\install\Install-VS-mlrt.cmd" /FULL
goto MAIN
